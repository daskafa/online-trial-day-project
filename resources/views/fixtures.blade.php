...
@section('content')
    ...
    <div class="mb-3">
        <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Home Team</span>
        <span class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Away Team</span>
    </div>
                    ...
                    <div class="mt-4">
                        @foreach($groupFixtureByWeek as $groupFixtureByWeekItem)
                            <div class="grid grid-cols-3 mt-3">
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $groupFixtureByWeekItem->homeTeam->name }}</span>
                                <span class="mx-2">vs</span>
                                <span class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">{{ $groupFixtureByWeekItem->awayTeam->name }}</span>
                            </div>
                        @endforeach
                    </div>
                </blockquote>
    ...
    <div class="">
        <a href="{{ url('') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2">
