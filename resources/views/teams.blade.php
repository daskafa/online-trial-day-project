...
@section('content')
    <div class="relative overflow-x-auto">
        ...
        <div class="py-3">
            <a href="{{ url('fixtures') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2">
